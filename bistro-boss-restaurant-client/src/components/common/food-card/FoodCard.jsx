            ...
            <div className="card bg-base-100 shadow-md rounded-md">
                ...
                <div className="card-body">
                    ...
                    <div className='card-actions justify-center mt-2'>
                        <button onClick={() => handleAddToCart(_id)} className='uppercase btn btn-warning btn-outline font-semibold rounded-sm border-0 border-b-2 btn-sm'>Add to cart</button>
                    </div>
                </div>
            </div>
        </div>
